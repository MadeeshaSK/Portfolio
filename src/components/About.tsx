  ...
  const education = [
    {
      ...
      details: 'CGPA 3.47',
      link: 'https://uom.lk/itfac/education/undergraduate/it',
      institutionLink: 'https://uom.lk/',
      resultLink: 'https://drive.google.com/file/d/1TcjQi20_ZLUuIh_UIrypzyEPnJj9koy6/view?usp=drive_link',
                ...
                >
                  ...
                  <div className="flex items-start space-x-4 relative z-10">
                    <div className="flex-shrink-0">
                      {edu.image ? (
                        <div className={`w-12 h-12 relative bg-gradient-to-br ${edu.gradient} rounded-lg p-1.5 flex items-center justify-center overflow-hidden group-hover:scale-110 group-hover:rotate-6 transition-all duration-500`}>
                          <Image
                            src={edu.image}
                            alt={edu.institution || edu.qualification}
                            fill
                            className="object-contain p-1"
                          />
                          {edu.status === 'current' && (
                            <div className="absolute -inset-1 bg-primary-400/30 rounded-lg blur animate-pulse pointer-events-none" />
                          )}
                        </div>
                      ) : (
                    ...
                    <div className="flex-1">
                      ...
                      {edu.institution && (
                        <p className="text-text-secondary text-sm mb-2 group-hover:text-secondary-400 transition-colors duration-300">
                          <a
                            href={edu.institutionLink || edu.link}
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    {certificates.map((cert, index) => (
                      ...
                      >
                        ...
                        {/* Category indicator */}
                        <span className={`ml-auto text-xs px-2 py-0.5 rounded-full opacity-0 group-hover/cert:opacity-100 transition-opacity duration-300 ${cert.category === 'cloud' ? 'bg-blue-500/20 text-blue-400' :
